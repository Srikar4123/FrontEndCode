...
export class AdminLogin implements OnInit, OnDestroy {
  ...
  register() {
    ...
    this.successMessage = 'Admin account created successfully! Redirecting to sign in...';
    
    // Auto switch to sign in after 2 seconds
    setTimeout(() => {
      console.log('Before switch - isExistingAdmin:', this.isExistingAdmin);
      this.successMessage = '';
      this.isExistingAdmin = true;
      this.clearFields();
      console.log('After switch - isExistingAdmin:', this.isExistingAdmin);
